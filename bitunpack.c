...
void demosaic(float** rawData, float** red, float** green, float** blue, int winx, int winy, int winw, int winh, int cfa);
...
static PyObject* bitunpack_demosaic14(PyObject* self, PyObject *args) {
...
static PyObject* bitunpack_demosaic16(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
...
static void bitunpack_freedemosaicer(PyObject* self) {
...
static PyObject* bitunpack_demosaicer(PyObject* self, PyObject *args) {
    int width = 0;
    int height = 0;
...
static PyObject* bitunpack_predemosaic12(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
    int length = 0;
    int width = 0;
    int height = 0;
...
static PyObject* bitunpack_predemosaic14(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
...
static PyObject* bitunpack_predemosaic16(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
...
static PyObject* bitunpack_demosaic(PyObject* self, PyObject *args) {
    PyObject* demosaicerobj;
...
static PyObject* bitunpack_postdemosaic(PyObject* self, PyObject *args) {
    PyObject* demosaicerobj;
...
static PyObject* bitunpack_unpack12to16(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
    int length = 0;
    int byteSwap = 0;
...
static PyObject* bitunpack_unpack14to16(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
    int length = 0;
    int byteSwap = 0;
    ...
    while (i<elements) {
        ...
        if (out==0) {
        	out = *(write-2); // Dead pixel masking
        }
...
static PyObject* bitunpack_unpackljto16(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
    int inlen = 0;
    char* output;
    int outlen = 0;
    ...
    if (!PyArg_ParseTuple(args, "t#w#iiit#", &input, &inlen, &output, &outlen, &outindex, &outwrite, &outskip, &lin, &linlen)) {
        return NULL;
    }
...
static PyObject* bitunpack_pack16tolj(PyObject* self, PyObject *args) {
    unsigned const char* input = 0;
    int inlen = 0;
    int width = 0;
    int height = 0;
    ...
    if (!PyArg_ParseTuple(args, "t#iiiiiit#", &input, &inlen, &width, &height, &bitdepth, &inindex, &inread, &inskip, &delin, &delinlen)) {
        return NULL;
    }

    //printf("width=%d,height=%d,inlen=%d\n",width,height,inlen);
    if (width*height*sizeof(uint16_t) > inlen) {
    	return NULL;
    }
...
static PyMethodDef methods[] = {{ "unpack14to16", bitunpack_unpack14to16, METH_VARARGS, "Unpack a string of 14bit values to 16bit values" },
...
PyMODINIT_FUNC initbitunpack(void) {
    PyObject* m;
